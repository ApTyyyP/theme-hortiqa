...
<body class="body-payment">
    <main>
        ...
        <section class="сheckout" style="background-image: url(<?= get_template_directory_uri(); ?>/assets/img/checkout/сheckout.png)">
            ...
            <div class="wrapper">
                <div class="сheckout__wrapper-box">
                    ...
                    <form class="form сheckout__form" action="/payment/">
                        ...
                        <ul class="сheckout__items сheckout__contact">
                            <li class="сheckout__item form__box">
                                <div class="сheckout__item-wrapper">
                            ...
                            <li class="сheckout__item form__box">
                                <div class="сheckout__item-wrapper сheckout__item-coment">
                        ...
                        <ul class="сheckout__items сheckout__delivery">
                            <li class="сheckout__item сheckout__del">
                                <label>
                                    <input
                            ...
                            <li class="сheckout__item form__box item__pickup">
                                <div class="сheckout__item-wrapper">
                        ...
                        <ul class="сheckout__items сheckout__payment">
                            <li class="сheckout__item">
                                <label>
                                    <input
                                        class="form__input-radio"
                                        type="radio"
                        ...
                        <ul class="сheckout__items сheckout__promo">
                            <li class="сheckout__item">
                                <div class="сheckout__inner">
                        ...
                        <div class="сheckout__inner-box">
                            <button class="сheckout__paymentbtn">До оплати</button>
                        </div>
                    </form>
